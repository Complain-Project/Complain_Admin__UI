                                ...
                                <div class="respondent pt-4">
                                    <div class="flex">
                                        <div class="w-[230px] flex items-center">
                                            <el-avatar :size="35" :src="complain?.respondent?.avatar ? complain.respondent.avatar : userDefault" />
                                    ...
                                    <div class="complain-reply__content">
                                        <div class="time" v-if="complain.appointment_time">
                                            <div class="px-[230px] mb-10">
                                                ...
                                                <p class="text-right my-3"><i>{{complain?.district?.name}}, {{ formatDateComplain(complain.updated_at) }}</i></p>
                                                <p class="text-center text-xl font-bold">THÔNG BÁO</p>
                                                <div class="text-base">
                                                    <p class="text-center font-bold">Về việc thụ lý giải quyết khiếu nại {{complain?.code}}</p>
                                                    ...
                                                    <p>Đơn khiếu nại đã được thụ lý giải quyết kể từ {{formatDate(complain.appointment_time)}}</p>
                                                    <p>Vậy thông báo để Ông(Bà) {{user?.name}} được biết.</p>
                                                    <p class="text-right font-bold">Người đứng đầu cơ quan, tổ chức, đơn vị</p>
                                                    <p class="text-right mr-10"><i>(Ký, ghi rõ họ tên và đóng dấu)</i></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
